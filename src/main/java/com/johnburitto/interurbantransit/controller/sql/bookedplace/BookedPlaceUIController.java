package com.johnburitto.interurbantransit.controller.sql.bookedplace;
...
import com.johnburitto.interurbantransit.model.sql.*;
...
import com.johnburitto.interurbantransit.service.impls.sql.TransportService;
...
public class BookedPlaceUIController {
    ...
    public String showAllInterval(Model model, @PathVariable String startDay, @PathVariable String endDay) throws IOException {
        ...
        return "/sql/booked-places-all-with-average";
    }

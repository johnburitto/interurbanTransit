...
<body>
    ...
    <script src="/static/nosql/scripts/bookedPlacesInterval.js?version=200"></script>
    <script src="/static/nosql/scripts/changeBookedPlacesFilters.js?version=400"></script>
    <script src="/static/nosql/scripts/bookedPlacePaging.js?version=400"></script>
</body>
</html>
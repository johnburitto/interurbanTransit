...
<head>
    ...
    <link href="/static/nosql/css/display-filters.css?version=1510" type="text/css" rel="stylesheet"/>
</head>
<body>
    ...
    <script src="/static/nosql/scripts/changeDriverFilters.js?version=400"></script>
    <script src="/static/nosql/scripts/driverPaging.js?version=400"></script>
</body>
</html>
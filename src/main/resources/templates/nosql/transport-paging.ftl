...
<body>
    ...
    <script src="/static/nosql/scripts/changeTransportDisplayFilters.js?version=400"></script>
    <script src="/static/nosql/scripts/transportPaging.js?version=400"></script>
</body>
</html>
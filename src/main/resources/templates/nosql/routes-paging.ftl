...
<head>
    ...
    <link href="/static/nosql/css/display-filters.css?version=1310" type="text/css" rel="stylesheet"/>
</head>
<body>
    ...
    <script src="/static/nosql/scripts/changeRouteDisplayFilters.js?version=400"></script>
    <script src="/static/nosql/scripts/routePaging.js?version=400"></script>
</body>
</html>
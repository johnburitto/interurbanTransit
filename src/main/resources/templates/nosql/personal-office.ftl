...
<head>
    ...
    <link href="/static/nosql/css/inputs.css?version=1610" type="text/css" rel="stylesheet"/>
    <link href="/static/nosql/css/project.css?version=4000" type="text/css" rel="stylesheet"/>
</head>
<body>
    <div class="app-container">
        <div class="oswald" style="width: 50%; display: flex; align-content: center; justify-content: center;
            ...
            <div class="input-container" style="flex-wrap: nowrap;">
                ...
                <span class="personal-office-data">${personalInf.name.firstName}</span>
            </div>
            <div class="input-container" style="flex-wrap: nowrap">
                <span class="input-text">Middle name:</span>
                <span class="personal-office-data">${personalInf.name.middleName}</span>
            </div>
            <div class="input-container" style="flex-wrap: nowrap">
                <span class="input-text">Last name:</span>
                <span class="personal-office-data">${personalInf.name.lastName}</span>
            </div>
            <div class="input-container" style="flex-wrap: nowrap">

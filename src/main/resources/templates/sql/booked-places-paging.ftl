...
<head>
    <meta charset="UTF-8">
    <title>Booked places paging</title>
    <link rel="preconnect" href="https://fonts.googleapis.com">
    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
    <link href="https://fonts.googleapis.com/css2?family=Oswald:wght@400;700&display=swap" rel="stylesheet">
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.2.0-beta1/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-0evHe/X+R7YkIZDRvuzKMRqM+OrBnVFBL6DOitfPri4tjfHxaWutUpFmBp4vmVor" crossorigin="anonymous">
    <link href="/static/sql/css/inputs.css?version=1310" type="text/css" rel="stylesheet"/>
...
<body>
                    ...
                    <#list bookedPlaces as bookedPlace>
                        <tr>
                            ...
                            <td class="align-middle hover-td" id="flight">
                                <b>Route:</b> ${bookedPlace.flight}
                            </td>
                            <td class="align-middle hover-td" id="passenger">
                                <div class="widget-holder">
                                    <p style="margin: 0; padding: 0">
                                        <b>Name:</b> ${bookedPlace.passenger}
                                    </p>
                                    <div class="widget">
                                        <button class="btn btn-outline-dark oswald-bold width-100"
                                                onclick="location.href='/ui/v1/booked-places/name/${bookedPlace.passenger}'">
                                            Find by name
                                        </button>
                                        <button class="btn btn-outline-dark oswald-bold width-100"
                                                onclick="location.href='/ui/v1/booked-places/last-name/${bookedPlace.passenger}'">
                                            Find by last name
                                        </button>
                                    </div>
                                </div>
    ...
    <script src="/static/sql/scripts/bookedPlacesInterval.js?version=200"></script>
    <script src="/static/sql/scripts/changeBookedPlacesFilters.js?version=400"></script>
    <script src="/static/sql/scripts/bookedPlacePaging.js?version=400"></script>
</body>
</html>
...
<head>
    ...
    <link href="/static/sql/css/display-filters.css?version=1910" type="text/css" rel="stylesheet"/>
</head>
<body>
        ...
        <div class="table-container">
            ...
            <div class="width-100">
                <table class="table table-hover text-center oswald">
                    ...
                    <tr>
                        <td class="align-middle hover-td" colspan="11">
                            <b>Number of flights:</b> ${numberOfFlights}<br>
                            <b>Average number of booked places:</b> ${averageNumber}
                        </td>
                    </tr>
                    </tbody>
                </table>
            ...
            <div class="width-100 filters-container oswald-bold" style="margin-top: 2%">
                <button class="btn btn-outline-dark"
                        onclick="location.href='/sql/ui/v1/booked-places/'">Back</button>
            </div>
        </div>
    </div>
</body>

...
<body>
        ...
        <div class="table-container">
            ...
            <label for="list" class="width-100 table-name oswald-bold">
                ...
                <button type="button" class="btn btn-outline-dark reverse-btn-outline-dark oswald-bold"
                        ...
                        onclick="location.href='/sql/ui/v1/route-profitabilities/add'">Create</button>
            </label>
            <div class="width-100">
    ...
    <script src="/static/sql/scripts/changeRouteProfitabilityDisplayFilters.js?version=500"></script>
</body>
</html>
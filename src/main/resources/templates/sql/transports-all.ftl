...
<head>
    ...
    <link href="/static/sql/css/display-filters.css?version=1410" type="text/css" rel="stylesheet"/>
</head>
<body>
        ...
        <div class="table-container">
            ...
            <label for="list" class="width-100 table-name oswald-bold">
                ...
                <button type="button" class="btn btn-outline-dark reverse-btn-outline-dark oswald-bold"
                        ...
                        onclick="location.href='/sql/ui/v1/transports/add'">Create</button>
            </label>
            <div class="width-100">
                    ...
                    <#list transports as transport>
                        <tr>
                            ...
                            <td class="align-middle hover-td" id="passport">
                                <b>Company:</b> ${transport.companyName}<br>
                                <b>Transport number:</b> ${transport.transportNumber}<br>
                            </td>
                            <td class="align-middle hover-td" id="number-of-places">${transport.numberOfBookedPlaces}/${transport.numberOfPlaces}</td>
                            ...
                            <td class="align-middle" style="display: ${perms.delete}">
                                <button type="button" class="btn btn-outline-dark oswald-bold"
                                        onclick="location.href='/sql/ui/v1/transports/delete/${transport.id}'">Delete</button>
                            </td>
                            <td class="align-middle" style="display: ${perms.edit}">
                                <button type="button" class="btn btn-outline-dark oswald-bold"
                                        onclick="location.href='/sql/ui/v1/transports/edit/${transport.id}'">Edit</button>
                            </td>
                        </tr>
                    </#list>
                    </tbody>
    ...
    <script src="/static/sql/scripts/changeTransportDisplayFilters.js?version=500"></script>
</body>
</html>
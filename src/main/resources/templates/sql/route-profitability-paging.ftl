...
<head>
    ...
    <link href="/static/sql/css/display-filters.css?version=1810" type="text/css" rel="stylesheet"/>
</head>
<body>
    ...
    <script src="/static/sql/scripts/changeRouteProfitabilityDisplayFilters.js?version=400"></script>
    <script src="/static/sql/scripts/routeProfitabilityPaging.js?version=400"></script>
</body>
</html>
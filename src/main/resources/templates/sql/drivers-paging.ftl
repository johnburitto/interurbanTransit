...
<head>
    ...
    <link href="/static/sql/css/display-filters.css?version=1510" type="text/css" rel="stylesheet"/>
</head>
<body>
    ...
    <script src="/static/sql/scripts/changeDriverFilters.js?version=400"></script>
    <script src="/static/sql/scripts/driverPaging.js?version=400"></script>
</body>
</html>
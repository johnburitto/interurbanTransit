...
<head>
    ...
    <link href="/static/sql/css/display-filters.css?version=1610" type="text/css" rel="stylesheet"/>
</head>
<body>
                    ...
                    <tbody>
                        <#list passengers as passenger>
                            <tr>
                                ...
                                <td class="align-middle hover-td" id="name">${passenger.firstName} ${passenger.middleName} ${passenger.lastName}</td>
                                <td class="align-middle hover-td" id="contact-inf">
                                    <b>Telephone:</b> ${passenger.telephoneNumber}<br>
                                    <b>E-mail:</b> ${passenger.getEMail()}
                                </td>
                                ...
                                <td class="align-middle" style="display: ${perms.delete}">
                                    <button type="button" class="btn btn-outline-dark oswald-bold"
                                            onclick="location.href='/sql/ui/v1/passengers/delete/${passenger.id}'">Delete</button>
                                </td>
                                <td class="align-middle" style="display: ${perms.edit}">
                                    <button type="button" class="btn btn-outline-dark oswald-bold"
                                            onclick="location.href='/sql/ui/v1/passengers/edit/${passenger.id}'">Edit</button>
                                </td>
                            </tr>
                        </#list>
                    </tbody>

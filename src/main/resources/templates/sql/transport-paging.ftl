...
<body>
                    ...
                    <#list transports as transport>
                        <tr>
                            ...
                            <td class="align-middle hover-td" id="passport"
                                onclick="location.href='/ui/v1/transport-passports/${transport.transportNumber}'">
    ...
    <script src="/static/sql/scripts/changeTransportDisplayFilters.js?version=400"></script>
    <script src="/static/sql/scripts/transportPaging.js?version=400"></script>
</body>
</html>
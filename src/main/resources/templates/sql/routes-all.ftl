...
<head>
    ...
    <link href="/static/sql/css/display-filters.css?version=1310" type="text/css" rel="stylesheet"/>
</head>
<body>
        ...
        <div class="table-container">
            ...
            <label for="list" class="width-100 table-name oswald-bold">
                ...
                <button type="button" class="btn btn-outline-dark reverse-btn-outline-dark oswald-bold"
                        ...
                        onclick="location.href='/sql/ui/v1/routes/add'">Create</button>
            </label>
            <div class="width-100">
                        ...
                        <tr>
                            ...
                            <td class="align-middle" style="display: ${perms.delete}">
                                <button type="button" class="btn btn-outline-dark oswald-bold"
                                        onclick="location.href='/sql/ui/v1/routes/delete/${route.id}'">Delete</button>
                            </td>
                            <td class="align-middle" style="display: ${perms.edit}">
                                <button type="button" class="btn btn-outline-dark oswald-bold"
                                        onclick="location.href='/sql/ui/v1/routes/edit/${route.id}'">Edit</button>
                            </td>
                        </tr>
                    </#list>
                    </tbody>
    ...
    <script src="/static/sql/scripts/changeRouteDisplayFilters.js?version=500"></script>
</body>
</html>
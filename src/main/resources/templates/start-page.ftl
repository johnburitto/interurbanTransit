                        ...
                        <#list flights as flight>
                            <tr>
                                ...
                                <td class="align-middle hover-td" id="transport"
                                    onclick="location.href='/ui/v1/transports/${flight.transport}'">
                                        ${flight.transport}
                                </td>
                                ...
                                <td class="align-middle hover-td" id="route">
                                    <div class="widget-holder">
                                        ...
                                        <div class="widget">
                                            <button class="btn btn-outline-dark oswald-bold"
                                                    onclick="location.href='/ui/v1/flights/canceled/route/${flight.route}'">
                                                Canceled
                                            </button>
                                            <button class="btn btn-outline-dark oswald-bold width-100"
                                                    onclick="location.href='/ui/v1/flights/waiting/route/${flight.route}'">
                                                Waiting
                                            </button>
                                            <button class="btn btn-outline-dark oswald-bold width-100"
                                                    onclick="location.href='/ui/v1/flights/completed/route/${flight.route}'">
                                                Completed
                                            </button>
                                            <button class="btn btn-outline-dark oswald-bold width-100"
                                                    onclick="location.href='/ui/v1/flights/postponed/route/${flight.route}'">
                                                Postponed
                                            </button>
                                            <button class="btn btn-outline-dark oswald-bold width-100"
                                                    onclick="location.href='/ui/v1/flights/in-road/route/${flight.route}'">
                                                In road
                                            </button>
                                        </div>
                                    </div>
